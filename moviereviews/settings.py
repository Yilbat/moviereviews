...
SECRET_KEY = 'django-insecure-c!%@&qff@s+z_(v53&=*kvvuw1kfzxot1rgx@%9hc&v@8#9knm'
...
MEDIA_URL = '/media/'
STATICFILES_DIRS = [
os.path.join('/home/yilbat/Desktop/Django/Turtorial_Projects/moviereviews/moviereviews/', "static"),
